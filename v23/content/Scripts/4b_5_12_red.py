...
A=np.genfromtxt('4b_5_12_13.dat', unpack=True)
X=[]
print(len(A[0,:]))
print(A[1,0])
print(A[1,1])
...
plt.plot(k[2:11],Y[0,11:20][::-1],'rx')
plt.plot(k[1:11],Y[0,20:30],'rx')
plt.plot(k[2:9],Y[0,30:38][::-1],'rx')

plt.xlabel('Wellenzahl k in 1/m')
plt.ylabel('Resonanzfrequenzen in Hz')
plt.legend(loc="best")
#plt.show()
plt.savefig('4b_5_red.jpg')
