...
A=np.genfromtxt('4_4_10x50mm.dat', unpack=True)
X=[]
print(len(A[0,:]))
print(A[1,0])
print(A[1,1])
...
plt.plot(k[1:10],Y[0,0:9],'rx')
plt.plot(k[0:10],Y[0,9:19][::-1],'rx')
plt.plot(k[1:9],Y[0,19:27],'rx')
plt.plot(k[1:9],Y[0,27:35][::-1],'rx')

plt.xlabel('Wellenzahl k in 1/m')
plt.ylabel('Resonanzfrequenzen in Hz')
plt.legend(loc="best")
#plt.show()
plt.savefig('4_4_10_red.jpg')
