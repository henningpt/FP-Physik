...
A=np.genfromtxt('4_5.dat', unpack=True)
X=[]
print(len(A[0,:]))
print(A[1,0])
print(A[1,1])
...
plt.plot(k[0:8],Y[0,15:23],'rx')
plt.plot(k[0:8],Y[0,23:31][::-1],'rx')
plt.plot(k[1:7],Y[0,31:37],'rx')
plt.plot(k[1:8],Y[0,37:44][::-1],'rx')

plt.xlabel('Wellenzahl k in 1/m')
plt.ylabel('Resonanzfrequenzen in Hz')
plt.legend(loc="best")
#plt.show()
plt.savefig('4_5_red.jpg')
