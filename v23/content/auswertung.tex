...
\subcaption{Spektrum mit und ohne Defekt.}
\end{subfigure}
\begin{subfigure}{0.34\textwidth}
...
\label{fig:4b_7_2c}
\end{figure}
Der Vergleich der Spektren mit Defekt und ohne Defekt zeigt, dass der Defekt einen deutlichen Einfluss auf die Bänder hat.
